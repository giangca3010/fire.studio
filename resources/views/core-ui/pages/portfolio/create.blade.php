                                    ...
                                    <select name="category_portfolio" class="form-select" aria-label="Default select example">
                                        ...
                                        @if(isset($category_portfolios))
                                            @foreach($category_portfolios as $key => $category_portfolio)
                                                <option {{old('status') == $category_portfolio->id ? 'selected' : ''}}
                                                    value="{{$category_portfolio->id}}">{{$category_portfolio->name_en . ' - '. $category_portfolio->name_vi}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    <div class="form-text text-danger">
                                        {{ $errors->first('category_portfolio') }}
                                    </div>
                                </div>
                            </div>
                        </div>
