...
@section('content')
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h5 class="mb-0">Thêm mới "Our Team"</h5>
        </div>
        <div class="card-body">
            <form action="{{route('ourTeam.store')}}" method="post">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <div style="width: 300px; height: 377px; cursor: pointer" class="avatar_upload border p-1">
                        ...
                        <img class="preview_img d-none w-100 h-100" src="{{ old('avatar') ?? '#'}}" alt="">
                    </div>
                    <input type="text" name="avatar" class="avatar_img invisible">
                    <div class="form-text text-danger">
                        {{ $errors->first('avatar') }}
                    </div>
                </div>
