            ...
            <div style="max-width: 500px">
                <div class="card-group d-block d-md-flex row">
                    <div class="card p-4 mb-0">
                      ...
                      <svg class="icon">
                        <use
                            xlink:href="{{ asset('admin-assets/vendors/@coreui/icons/svg/free.svg#cil-user') }}"></use>
                      </svg></span>
                      ...
                      <svg class="icon">
                        <use
                            xlink:href="{{ asset('admin-assets/vendors/@coreui/icons/svg/free.svg#cil-lock-locked') }}"></use>
                      </svg></span>
