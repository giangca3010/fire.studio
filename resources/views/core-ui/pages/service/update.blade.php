                        ...
                        <div class="d-flex">
                            <div class="flex-grow-1 me-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{  $service->title_en}}" name="title_en"
                                           class="form-control"
                                           placeholder="Title">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="service_en" id="exampleFormControlTextarea1"
                                              rows="3">{{$service->service_en}}</textarea>
                                    <div class="form-text text-danger">
                            ...
                            <div class="flex-grow-1 me-3">
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Title </label>
                                    <input type="text" value="{{  $service->title_vi }}" name="title_vi"
                                           class="form-control"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="service_vi" id="exampleFormControlTextarea1"
                                              rows="3">{{$service->service_vi }}</textarea>
                                    <div class="form-text text-danger">
                        ...
                        <div class="d-flex">
                            <div class="flex-grow-1 me-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{$service->icon }}" name="icon"
                                           class="form-control"
                                           placeholder="Icon">
                                </div>
                            </div>
                            <div class="flex-grow-1 me-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" value="{{$service->position }}" name="position"
                                           class="form-control"
